...
parser = argparse.ArgumentParser(description='[MCANet] Long Sequences Forecasting')

parser.add_argument('--model', type=str, required=True, default='mcanet',help='model of experiment: MCANet')
